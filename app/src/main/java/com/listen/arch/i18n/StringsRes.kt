...
object StringsRes {
    ...
    private val commonZhMap = mapOf(
        ...
        "sync_msg_syncing" to "正在加密同步至云端...",
        "sync_msg_backup_success" to "云端备份成功",
        "sync_msg_restore_success" to "云端数据检索成功",
        "sync_msg_failed" to "云端同步失败",
        "sync_err_not_logged_in" to "未登录账户，无法进行云端备份！",
        "sync_err_no_snapshot" to "当前账户在云端暂无历史备份，请先执行备份！",
    ...
    private val commonEnMap = mapOf(
        ...
        "sync_msg_syncing" to "Encrypting and syncing to cloud...",
        "sync_msg_backup_success" to "Cloud backup completed successfully",
        "sync_msg_restore_success" to "Cloud data retrieved successfully",
        "sync_msg_failed" to "Cloud sync failed",
        "sync_err_not_logged_in" to "Not signed in, cloud backup unavailable!",
        "sync_err_no_snapshot" to "No cloud backup found for this account. Please backup first!",
    ...
    private val commonJaMap = mapOf(
        ...
        "sync_msg_syncing" to "クラウドへ暗号化同期中...",
        "sync_msg_backup_success" to "クラウドバックアップが完了しました",
        "sync_msg_restore_success" to "クラウドデータの取得に成功しました",
        "sync_msg_failed" to "クラウド同期に失敗しました",
        "sync_err_not_logged_in" to "未ログインのため、クラウド同期をご利用いただけません",
        "sync_err_no_snapshot" to "クラウド上にバックアップが見つかりません。先にバックアップを行ってください",
