...
/**
 * Built-in system-level string dictionaries for common UI actions across all Listen apps.
 */
internal object CommonStringsDictionary {

    val commonZhMap = mapOf(
        "common_ok" to "确定",
        "common_cancel" to "取消",
        "common_save" to "保存",
        "common_delete" to "删除",
