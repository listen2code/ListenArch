...
class BaseDataStoreKeysTest {
    ...
    fun testCompanionKeys() {
        ...
        assertEquals("currency_symbol", BaseDataStoreManager.KEY_CURRENCY_SYMBOL.name)
        ...
        assertEquals("monthly_budget", BaseDataStoreManager.KEY_MONTHLY_BUDGET.name)
        ...
        assertNotNull(BaseDataStoreManager.KEY_CURRENCY_SYMBOL)
    }
}
